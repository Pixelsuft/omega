...
#define OMG_REN_TEXTURE_FROM_FILE(ren, path) ren->tex_from_surf(ren, ((OMG_Omega*)ren->omg)->winmgr->surf_from_fp(((OMG_Omega*)ren->omg)->winmgr, NULL, path, OMG_IMG_FORMAT_AUTO), true)
