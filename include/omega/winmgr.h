...
typedef struct OMG_Winmgr {
    ...
    OMG_Surface* (*surf_from_path)(struct OMG_Winmgr* this, const OMG_String* path, int format);
...
OMG_API OMG_Surface* omg_winmgr_surf_from_path(OMG_Winmgr* this, const OMG_String* path, int format);
#endif
