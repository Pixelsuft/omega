...
#define OMG_IMG_FORMAT_NONE (1 << 0)
...
typedef struct OMG_ImageLoader {
    ...
    bool (*image_from_internal)(struct OMG_ImageLoader* this, int type, const void* data, void* buf, int format);
...
#if OMG_EXPORT_SHIT
OMG_API bool omg_image_loader_image_from(OMG_ImageLoader* this, int type, const void* data, void* buf, int format);
#endif
