...
OMG_API bool omg_renderer_win_draw_ellipse(OMG_RendererWin* this, const OMG_FPoint* pos, float rx, float ry, const OMG_Color* col);
OMG_API bool omg_renderer_win_fill_ellipse(OMG_RendererWin* this, const OMG_FPoint* pos, float rx, float ry, const OMG_Color* col);
