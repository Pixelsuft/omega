...
#define OMG_ARRAY_PUSH_DUMMY(this) omg_array_push_dummy((OMG_ArrayBase*)(this), (size_t)sizeof(*(this)->data))
...
/* Init array with initial length, chunk size (0 for default) */
...
OMG_API bool omg_array_push_dummy(OMG_ArrayBase* this, size_t elem_size);
/* Reserve length */
OMG_API bool omg_array_reserve_len(OMG_ArrayBase* this, size_t need_len, size_t elem_size);
/* Remove element */
