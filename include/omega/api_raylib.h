...
typedef struct {
    ...
    void OMG_RAYLIB_PREFIX (*ShowCursor)(void);
    void OMG_RAYLIB_PREFIX (*HideCursor)(void);
    bool OMG_RAYLIB_PREFIX (*IsCursorHidden)(void);
    ...
    void OMG_RAYLIB_PREFIX (*SetWindowMonitor)(int);
    int OMG_RAYLIB_PREFIX (*GetMonitorCount)(void);
    int OMG_RAYLIB_PREFIX (*GetCurrentMonitor)(void);
    Vector2 OMG_RAYLIB_PREFIX (*GetMonitorPosition)(int);
    int OMG_RAYLIB_PREFIX (*GetMonitorWidth)(int);
    int OMG_RAYLIB_PREFIX (*GetMonitorHeight)(int);
    int OMG_RAYLIB_PREFIX (*GetMonitorPhysicalWidth)(int);
    int OMG_RAYLIB_PREFIX (*GetMonitorPhysicalHeight)(int);
    int OMG_RAYLIB_PREFIX (*GetMonitorRefreshRate)(int);
    Vector2 OMG_RAYLIB_PREFIX (*GetWindowPosition)(void);
    Vector2 OMG_RAYLIB_PREFIX (*GetWindowScaleDPI)(void);
