...
OMG_API OMG_SurfaceRaylib* omg_winmgr_raylib_surf_from_fp(OMG_WinmgrRaylib* this, OMG_SurfaceRaylib* surf, const OMG_String* path, int format);
OMG_API OMG_SurfaceRaylib* omg_winmgr_raylib_surf_create(OMG_WinmgrRaylib* this, OMG_SurfaceRaylib* surf, const OMG_FPoint* size, bool has_alpha);
