...
typedef struct {
    ...
    double OMG_SDL2_STD_PREFIX (*SDL_sin)(double);
    double OMG_SDL2_STD_PREFIX (*SDL_cos)(double);
    double OMG_SDL2_STD_PREFIX (*SDL_tan)(double);
    double OMG_SDL2_STD_PREFIX (*SDL_atan)(double);
    double OMG_SDL2_STD_PREFIX (*SDL_atan2)(double, double);
    double OMG_SDL2_STD_PREFIX (*SDL_sqrt)(double);
    double OMG_SDL2_STD_PREFIX (*SDL_fmod)(double, double);
    float OMG_SDL2_STD_PREFIX (*SDL_sinf)(float);
    float OMG_SDL2_STD_PREFIX (*SDL_cosf)(float);
    float OMG_SDL2_STD_PREFIX (*SDL_tanf)(float);
    float OMG_SDL2_STD_PREFIX (*SDL_atanf)(float);
    float OMG_SDL2_STD_PREFIX (*SDL_atan2f)(float, float);
    float OMG_SDL2_STD_PREFIX (*SDL_sqrtf)(float);
    float OMG_SDL2_STD_PREFIX (*SDL_fmodf)(float, float);
    void OMG_SDL2_STD_PREFIX (*SDL_qsort)(void*, size_t, size_t, int (*) (const void*, const void*));
    int OMG_SDL2_STD_PREFIX (*SDL_abs)(int);
    double OMG_SDL2_STD_PREFIX (*SDL_fabs)(double);
    ...
    void OMG_SDL2_STD_PREFIX (*SDL_SetWindowIcon)(SDL_Window*, SDL_Surface*);
    void OMG_SDL2_STD_PREFIX (*SDL_ShowWindow)(SDL_Window*);
    void OMG_SDL2_STD_PREFIX (*SDL_HideWindow)(SDL_Window*);
    void OMG_SDL2_STD_PREFIX (*SDL_RaiseWindow)(SDL_Window*);
    ...
    int OMG_SDL2_STD_PREFIX (*SDL_LockSurface)(SDL_Surface*);
    int OMG_SDL2_STD_PREFIX (*SDL_UnlockSurface)(SDL_Surface*);
