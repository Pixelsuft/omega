...
typedef struct {
    ...
    float OMG_SDL2_STD_PREFIX (*SDL_sinf)(float x);
    float OMG_SDL2_STD_PREFIX (*SDL_cosf)(float x);
    float OMG_SDL2_STD_PREFIX (*SDL_tanf)(float x);
    float OMG_SDL2_STD_PREFIX (*SDL_atanf)(float x);
    float OMG_SDL2_STD_PREFIX (*SDL_atan2f)(float x, float y);
    float OMG_SDL2_STD_PREFIX (*SDL_sqrtf)(float x);
    float OMG_SDL2_STD_PREFIX (*SDL_fmodf)(float x, float y);
    void OMG_SDL2_STD_PREFIX (*SDL_qsort)(void*, size_t, size_t, int (*) (const void*, const void*));
    int OMG_SDL2_STD_PREFIX (*SDL_abs)(int n);
    double OMG_SDL2_STD_PREFIX (*SDL_fabs)(double n);
    float OMG_SDL2_STD_PREFIX (*SDL_fabsf)(float n);
